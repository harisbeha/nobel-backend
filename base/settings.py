...
SUPPORT_APPS = ['rest_framework', 'django_extensions', 'debug_toolbar', 'nested_admin', 'audit_trail']
CUSTOM_APPS = ['custom_apps.authentication', 'custom_apps.invoices', 'custom_apps.utils']
